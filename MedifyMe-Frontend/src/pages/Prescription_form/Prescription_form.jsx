...
function Home() {
  ...
  <label className={ styles.docter_name}  htmlFor="doctor-name">Medicines</label>
  <input className={styles.health_input} type="text" id="doctor-name" name="doctor-name" required />
  
  <label  className={ styles.text_health}  htmlFor="doctor-comments">Prescription Comments:</label>
