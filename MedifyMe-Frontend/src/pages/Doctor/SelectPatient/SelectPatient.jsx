        ...
        <div className={styles.right_wrapper}>
          ...
          <div className={styles.row}>
            <div className={styles.add_doctor_info}>
              <label className={styles.add_text_doctor} htmlFor="email">Active Patient:</label>
              ...
              <button className={styles.select_btn} type="submit">Select</button>
            </div>

            <div className={styles.add_patients}>
              <p className={styles.add_patients_p}>Add Patients</p>
              <label className={styles.add_text_doctor} htmlFor="email">Patient Id:</label>
              <input className={styles.add_patient_id}type="ID"id="ID"name="patient_id"required/>
            ...
            <div className={styles.patient}>
              <p className={styles.patient_name}>&nbsp;&nbsp;&nbsp;1. Joey Tribbiani</p>
              <p className={styles.patient_id}>#IN2839TRN</p>
              <p className={styles.friend_requests}><button className={styles.ignorebtn}>Ignore</button><button className={styles.acceptbtn}>Accept</button></p>
            </div>
            <div className={styles.patient}>
              <p className={styles.patient_name}>&nbsp;&nbsp;&nbsp;2. Rachael Green</p>
              <p className={styles.patient_id}>#PK9741QSL</p>
              <p className={styles.friend_requests}><button className={styles.ignorebtn}>Ignore</button><button className={styles.acceptbtn}>Accept</button></p>
            </div>
            <div className={styles.patient}>
              <p className={styles.patient_name}>&nbsp;&nbsp;&nbsp;3. Pheobe Buffay</p>
